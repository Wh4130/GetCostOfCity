...
if st.button("submit"):
    # response = requests.post("https://getcostofcity.onrender.com/source_html", json={"city": city})
    ...
    response = requests.get(f"https://getcostofcity.onrender.com/expenses?city={city}", json={"city": city})
